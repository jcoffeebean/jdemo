...
<html>
	...
	<p style="color:blue;font-weight: bold;font-size:18px;">使用下面这个指令就会报错: java.io.IOException: Stream closed</p>
...
java.io.IOException: Stream closed
	...
	解决办法：将包含的静态的html文件form-commit.html改成form-commit.jsp
	</p>
